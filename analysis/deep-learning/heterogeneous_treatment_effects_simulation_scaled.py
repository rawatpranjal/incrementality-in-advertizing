...
# Output paths
DATA_DIR = Path('/Users/pranjal/Code/marketplace-incrementality/panel_dnn/data')
RESULTS_DIR = Path('/Users/pranjal/Code/marketplace-incrementality/panel_dnn/results')
