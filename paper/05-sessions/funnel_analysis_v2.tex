\section{Analysis of Shopping Sessions}
...
\begin{figure}[htbp!]
\centering
\IfFileExists{figures/session_construction.pdf}{%
  \includegraphics[width=\textwidth]{figures/session_construction.pdf}%
}{%
  % Placeholder when the compiled figure is not present in the repo
  \rule{0.9\textwidth}{0.35\textwidth}%
}
\caption{Macro-session construction from raw event streams using 3-day inactivity gaps.}
