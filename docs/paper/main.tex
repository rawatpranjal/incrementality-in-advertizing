...
\title{Measuring Advertizing Effectiveness in an Online Marketplace}
\author{
...
\input{literature_optimization.tex}
\input{marketplace.tex}
\input{data.tex}

% shopping sessions
\input{funnel_analysis_v2.tex}

% event sampling design
\input{event_sampling_design.tex}

% weekly panels
\input{weekly_panel.tex}
